...
label_ext = ".png" # Label should all be in this format
...
if __name__ == '__main__':
    ...
    if not os.path.isdir(args.i) or not os.path.isdir(args.l):
    ...
    for ext in supported_ext:
        tra_img_name_list.extend(glob.glob(os.path.join(args.i, '*' + ext)))
    ...
    for img_path in tra_img_name_list:
        ...
        tra_lbl_name_list.append(os.path.join(args.l, imidx + label_ext))
